...
<!-- for next time I teach the course
## Test bank
The GSIs and the Instructors will work on developing a test bank associated with each topic. A subset of the questions in this test bank will be selected into the problem sets. Another set of questions will be randomly selected into the midterms and final exam, and modified only slightly. This is to encourage students to work in groups to master all the questions in the test bank. There will not be an answer sheet for the entire test bank. 
-->
